...
//import cl4d.cl_platform;
import cl4d.c.cl;

extern(System):

mixin CLTypedef!(cl_uint,	 "cl_gl_object_type");
alias cl_uint	 cl_gl_texture_info;
alias cl_uint	 cl_gl_platform_info;
mixin CLTypedef!(const(void*), "cl_GLsync"); // typedef struct __GLsync *cl_GLsync;
...
mixin CLTypedef!(cl_uint, "cl_gl_context_info");
...
mixin CLTypedef!( cl_errcode function(
		const(cl_context_properties)*	properties,
		cl_gl_context_info				param_name,
		size_t							param_value_size,
		void*							param_value,
